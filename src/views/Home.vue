...
$cloudColorHover: rgba(65, 139, 141, 1);
$stickyRiceColor: rgba(209, 201, 38, 1);
$stickyRiceColorHover: rgba(139, 134, 25, 1);
...
.sticky-rice-color {
  background-color: $stickyRiceColor;
}
.home {
  .figure {
    width: 385px;
...
.navigation-main {
  .nav-main-item {
    ...
    &.pink-color:hover {
      background-color: $pinkColorHover;
    }
    &.cloud-color:hover {
